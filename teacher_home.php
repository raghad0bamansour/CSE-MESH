...
<div id="images">
  <div class="col">
    <figure>
        <a href="manage_office_hour.php"><img src="img/hour.png" class="img-thumbnail" style="width:55%" alt=""></a>
        <figcaption><strong>Manage Office Hour</strong></figcaption>
    </figure>
  </div>
  <div class="col">
    <figure>
  ...
  <div class="col">
    <figure>
        <a href="manage_workshop.php"><img src="img/manage.png" class="img-thumbnail" style="width:55%" alt=""></a>
        <figcaption><strong>Manage Workshop</strong></figcaption>
    </figure>
  </div>
</div>
</a>
